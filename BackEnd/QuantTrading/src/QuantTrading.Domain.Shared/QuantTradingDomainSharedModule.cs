...
public class QuantTradingDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        QuantTradingGlobalFeatureConfigurator.Configure();
        QuantTradingModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<QuantTradingDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<QuantTradingResource>("zh-Hans")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/QuantTrading");

            options.DefaultResourceType = typeof(QuantTradingResource);
        ...
        {
            options.MapCodeNamespace("QuantTrading", typeof(QuantTradingResource));
        });
    }
}
